...
--
-- Dumping data for table `best_selling`
--

INSERT INTO `best_selling` (`id`, `product_id`) VALUES
(1, 1),
(2, 4),
(3, 5),
(4, 8),
...
--
-- Indexes for table `best_selling`
--
...
--
-- AUTO_INCREMENT for table `best_selling`
--
ALTER TABLE `best_selling`
...
--
-- Constraints for table `best_selling`
--
ALTER TABLE `best_selling`
  ADD CONSTRAINT `best_selling_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`);
